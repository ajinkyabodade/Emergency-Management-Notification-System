...
<head>
    ...
    <title>Received Requests For Events</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody ><?php include('rrnotificationfetch.php'); ?></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
           // setInterval(function(){
               ...
               // xmlhttp.open("GET","rrnotificationfetch.php",false);
               // xmlhttp.send(null);
               // document.getElementById("rrnotificationfetch").innerHTML=xmlhttp.responseText;
